...
const StyledTable = ({
  ...
  return (
    <>
      ...
      <h2 className="font-black text-stone-700 dark:text-stone-200 uppercase tracking-widest text-xl md:text-2xl drop-shadow-sm select-none mt-8 mb-4 pl-2 md:pl-0">
        {tableName}
      </h2>
      <table
